                ...
                if not common_data.empty:
                    ...
                    with tabs[0]:
                        ...
                        if overwrite:
                            ...
                            df = df.merge(db_df, on=df.columns.tolist(), how='left', indicator=True).query(
                    ...
                    if user_name in admins:
                        ...
                        tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(
                            ["Dashboard", "Summary", "Bank Entries", "Feedback", "Razorpay", "Categories"])
                    else:
                        # Apply CSS to reduce white space above tabs
                        st.markdown(
                            """
                        ...
                        if st.button("Submit Feedback"):
                            if feedback:  # Checking if input is not empty
                                try:
                                    ...
                                    send_email(feedback, user_email, uploaded_file, ADMIN_EMAILS, SMTP_SERVER, SMTP_USER,
                                               SMTP_PASSWORD)
